  ...
  return (
    <section className="flex h-full flex-col rounded-xl border border-border bg-card">
      ...
      <footer className="flex items-center gap-4 border-t border-border px-5 py-3 text-xs text-muted-foreground">
        <LegendDot color="#B08A4A" label="Recebidas" />
        <LegendDot color="#1F3A26" label="Enviadas" />
      </footer>
    </section>
  )
}
  ...
  return (
    <div ref={wrapRef} className="relative w-full">
      ...
      >
        ...
        {/* Outgoing polyline (forest green — team action) */}
        <path
          d={outgoingPath}
          fill="none"
          stroke="#1F3A26"
        ...
        />
        {/* Incoming polyline (old gold — positive) */}
        <path
          d={incomingPath}
          fill="none"
          stroke="#B08A4A"
        ...
        {hover !== null && (
          <g pointerEvents="none">
            <line
              ...
              strokeDasharray="3 3"
            />
            <circle cx={hoverX} cy={yFor(data[hover.idx].incoming)} r={3.5} fill="#B08A4A" />
            <circle cx={hoverX} cy={yFor(data[hover.idx].outgoing)} r={3.5} fill="#1F3A26" />
          </g>
        )}
      </svg>
        ...
        >
          ...
          <div className="mt-1 flex flex-col gap-0.5">
            <span className="flex items-center gap-1.5 text-amber-700 dark:text-amber-400">
              <span className="inline-block h-1.5 w-1.5 rounded-full" style={{ background: "#B08A4A" }} />
