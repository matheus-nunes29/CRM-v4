...
export function InviteMemberDialog({
  ...
  function whatsappShareUrl(url: string): string {
    ...
    const message = `Junte-se a ${accountName} no wacrm usando este link (válido por ${result?.expiresInDays} dia${result?.expiresInDays === 1 ? '' : 's'}): ${url}`;
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                se cadastrar (ou entrar) e entrar na conta como{' '}
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md border border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
                ...
                Nunca armazenamos o texto simples — uma vez que você feche este diálogo
                o URL desaparece. Para recompartilhar, revogue este convite e crie
                um novo.
              </div>
