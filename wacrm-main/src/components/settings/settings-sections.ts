...
export const SECTION_META: Record<SettingsSection, SectionMeta> = {
  ...
  'quick-templates': { id: 'quick-templates', label: 'Templates Rápidos', icon: MessageSquare, group: 'workspace' },
  tracking: { id: 'tracking', label: 'Links rastreáveis', icon: Link2, group: 'workspace' },
