        ...
        <>
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">
              Interpole em prompts posteriores e notas de transferência com{" "}
    ...
    case "end":
      return (
        <p className="text-xs text-muted-foreground">
          Nó terminal. Quando o executor chegar a este nó, a execução é marcada como concluída. Nenhuma configuração necessária.
        </p>
      );
  }
}
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <TextRow
          label="Rótulo do botão de expandir (≤20 chars)"
